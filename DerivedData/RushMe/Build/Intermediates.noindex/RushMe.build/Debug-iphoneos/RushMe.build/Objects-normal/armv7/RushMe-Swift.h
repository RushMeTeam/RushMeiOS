...
- (void)loadCampusFromDict:(NSArray<NSDictionary<NSString *, id> *> * _Nonnull)dictArray SWIFT_DEPRECATED_OBJC("Swift method 'Campus.loadCampus(fromDict:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
