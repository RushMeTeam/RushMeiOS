...
@property (nonatomic, readonly, copy) NSSet<FratEvent *> * _Nonnull favoritedFratEvents SWIFT_DEPRECATED_OBJC("Swift property 'Campus.favoritedFratEvents' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (nonnull instancetype)initWithLoadFromFile:(BOOL)loadFromFile SWIFT_DEPRECATED_OBJC("Swift initializer 'Campus.init(loadFromFile:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)filterEventsForFavorites SWIFT_DEPRECATED_OBJC("Swift method 'Campus.filterEventsForFavorites()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
- (void)pullFratsFromSQLDatabaseWithTypes:(NSArray<NSString *> * _Nonnull)types;
...
+ (NSURL * _Nullable)exportAsICSWithEvents:(NSArray<FratEvent *> * _Nonnull)events SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'RushCalendarManager.exportAsICS(events:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
