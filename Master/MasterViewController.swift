...
UIGestureRecognizerDelegate, UIPageViewControllerDelegate {
  ...
  lazy var setupSearchBar : Void = {
    ...
    searchController.searchBar.tintColor = Frontend.colors.AppColor
...
//    searchController.searchBar.backgroundColor = Frontend.colors.AppColor
  ...
  func updateSearchBar() {
    let fraternityCount = Campus.shared.fraternityNames.count 
    self.searchController.searchBar.placeholder = "Search \(fraternityCount > 2 ? "\(fraternityCount) ": "")Fraternities"
